...
use Absensi\Controllers\AbsensiController;

$absensiController = new AbsensiController();
$dataAbsensi = $absensiController->getAbsensi();
$statistik = $absensiController->hitungStatistik($dataAbsensi);
?>
<!DOCTYPE html>
<html lang="id">
<head>
        ...
        <div class="row">
            <div class="col-12">
                <div class="alert alert-primary" role="alert">
                    ...
                    <p>Selamat datang di sistem manajemen absensi kajian kitab PP. Annuqayah Lubangsa. Pantau kehadiran dan perkembangan santri dengan mudah.</p>
                </div>
            </div>
        </div>
